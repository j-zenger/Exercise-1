...
#Here, I am creating a function that will only display the observations in the data set when there was a rebound, using the etype column. Here's where I get a bit confused, because data is an arbitrary term for the data set, which is specific to whatever data set I used. So how can I change the name of the argument itself when its name is what calls the data set forward? Anyways, that is why I simply changed the name of the function. Will return to this if I get some answers. 
